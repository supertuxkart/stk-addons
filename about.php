...
$tpl = array();
$tpl['title'] = htmlspecialchars(_('STK Add-ons').' | '._('About'));
...
$tpl['about'] = array(
	...
	'content' => array(
	    ...
	    sprintf(htmlspecialchars(_('SuperTuxKart now has over %d karts, %d tracks, and %d arenas available in-game thanks to the add-on service.')),40,30,15),
